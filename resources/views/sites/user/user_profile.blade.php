...
@section('style')
    {{ HTML::style('/css/sites/profile.css', ['rel' => 'stylesheet', 'type' => 'text/css']) }}
@endsection
    ...
    <div class="col-sm-3 sidebar">
        ...
        <div class="row"><!--left col-->
            <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong>Address</strong></span> {!! $users->address !!}</li>
            </ul>
        </div><!--/col-3-->
    </div>
    <div class="col-sm-8">
